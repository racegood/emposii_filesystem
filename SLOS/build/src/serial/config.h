...
/* Serial baudrate */
#define 	SERIAL_SPEED_RATE	(0x00000060) // 9600bps
...
#define	RAMDISK_LENGHT		(6*1024*1024) //7M byte

#define	USR_RAM_BASE		0xa0600000
#define	USR_ROM_BASE		0x00900000
#define	USR_LENGHT			(0x2000000 - USR_ROM_BASE) //23M byte
